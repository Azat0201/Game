...
'''
Version: 2.2.0 (from 15.11.23)
Programm name: "Menu.py"
Game Name: "Snake" or "Змейка"
Author: Ismankiy Azat (Исманский Азат)
Link to download: 

Base game and rules snake
This test game, because may be arise errors or programm can work incorrect 
'''
